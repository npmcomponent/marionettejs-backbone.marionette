...
(function (root, factory) {
  if (typeof exports === 'object') {
    ...
    var underscore = require('jashkenas-underscore');
    var backbone = require('jashkenas-backbone');
    var wreqr = require('marionettejs-backbone.wreqr');
    var babysitter = require('marionettejs-backbone.babysitter');
